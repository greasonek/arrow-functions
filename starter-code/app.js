...
//  "this" gathers the parameters of the object being called
// 2. What is "this" when joe.scopeArrow() is invoked?
//  "this" is not binding in arrow functions and represents the object that defined the arrow function 
// 3. Explain why "this" is different when an arrow function is used.
//  The value of "this" is determined by how the function is called and is not linked to the function itself but to the object of the function.